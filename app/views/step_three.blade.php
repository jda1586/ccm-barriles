               ...
               <div style="max-width: 1024px; margin: 20px auto; font-family: Droid 300;">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-6 col-md-offset-6">
                             <button class="close" data-dismiss="modal" type="button" style="background-color: white; width: 30px; height: 28px; padding-bottom:5px">
                                <span aria-hidden="true" style="color: red; font-size: 20px; margin-bottom: 5px;">x</span>
